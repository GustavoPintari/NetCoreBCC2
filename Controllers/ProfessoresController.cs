...
namespace WebCoreBCC2.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,nome,idade,cidade,endereco,contato,email")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,nome,idade,cidade,endereco,contato,email")] Professor professor)
        {
            if (id != professor.ID)
            {
                return NotFound();
